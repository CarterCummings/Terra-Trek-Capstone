  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  cfg_.bl_wheel_name = info_.hardware_parameters["bl_wheel_name"];
  cfg_.br_wheel_name = info_.hardware_parameters["br_wheel_name"];
  ...
  wheel_bl_.setup(cfg_.bl_wheel_name, cfg_.enc_counts_per_rev);
  wheel_br_.setup(cfg_.br_wheel_name, cfg_.enc_counts_per_rev);
  wheel_fl_.setup(cfg_.fl_wheel_name, cfg_.enc_counts_per_rev);
  wheel_fr_.setup(cfg_.fr_wheel_name, cfg_.enc_counts_per_rev);
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{
  ...
  comms_.read_encoder_values(wheel_bl_.enc, wheel_br_.enc, wheel_fl_.enc, wheel_fr_.enc);

  double delta_seconds = period.seconds();

  double pos_prev = wheel_bl_.pos;
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  comms_.set_motor_values(motor_bl_counts_per_loop, motor_br_counts_per_loop, motor_fl_counts_per_loop, motor_fr_counts_per_loop);
  return hardware_interface::return_type::OK;
}
